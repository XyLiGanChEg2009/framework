            ...
            if (func) {
                ...
                if (f) {
                    ...
                    if ((a || b) && a !== b) {
                        if (showIntegral) {
                            if (a > b) {
                                this.graph2D.printIntegral(f, b, a, this.graph2D.getIntegral(f, b, a));
                            } else {
                                this.graph2D.printIntegral(f, a, b, this.graph2D.getIntegral(f, a, b))
                            }
                        }
                        if (this.graph2D.getZero(f, a, b) !== null) {
                            this.canvas.point(this.graph2D.getZero(f, a, b), 0);
                        }
                    }
                }
            }
